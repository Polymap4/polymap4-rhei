...
public class Svg2PngTest {
    ...
    public void testSVGBounds() throws Exception {
        URL svgInputURL = getClass().getResource( "Vector-based_example.svg" );
        try (InputStream svgInput = getClass().getResourceAsStream( "Vector-based_example.svg" )) {
    ...
    public void testScaleSVG() throws Exception {
        ...
        try (InputStream svgInput = getClass().getResourceAsStream( "Vector-based_example.svg" )) {
            ...
            svg2Png.transcode( svgInputURL.toString().replace( ".svg", ".png" ), "Vector-based_example.svg", svgInput, Collections.singletonList(SCALE.P16), Collections.singletonList(imageConfig) );
            URL pngURL = getClass().getResource( "Vector-based_example_P16.png" );
